...
Testing: https://hackernoon.com/a-guide-to-tdd-a-react-redux-todolist-app-part-1-b8a200bb7091

Need to add code for Adaptor for enzym.

Initially fails due to lack of jest-cli...

when jest-cli is installed manually I get a new error on npm run test... Screen all red. "Determining test suites to run...Error: This promise must be present when running with -o." 

SOLUTION: Do not install jest-cli.
Delete the folder from node_modules manually if you have to. 

Remove references to enzyme stuff and enzyme.

Do npm run test - it should run properly but it will pass if its the default, fail if you have edited it.

Then yuo can add the required packages and it should pass.
